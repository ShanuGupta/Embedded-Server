It is a java web application having jetty server embedded into it. It can start/stop the server and register servlets to the server programatically at runtime.
